...
*/
package tech.koncierge.generator;
...
public class ConfigurationGenerator {
    ...
    public ConfigurationGenerator(Config config, DeploymentRequirements deploymentRequirements) {
        this.config = config;
        this.deploymentRequirements = deploymentRequirements;
    }

    public KubernetesConfiguration generate() {
        KubernetesGenerator kubernetesGenerator = new KubernetesGenerator(config, deploymentRequirements);
        return kubernetesGenerator.generate();
    }
}
