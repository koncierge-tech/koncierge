...
*/
package tech.koncierge.model.deployment.requirements.routes;
...
public class SubDomainRoute extends Route {

    private String subDomain;

    public SubDomainRoute(Application application, Port port, String subDomain) {
